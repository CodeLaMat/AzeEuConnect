...
router.post("/services", authenticateUser, authorizeMiddleware(Action.POST_SERVICE), createServiceListing);
...
router.patch("/services/:id", authenticateUser, authorizeMiddleware(Action.MANAGE_ORDERS), updateServiceListing);
// Route to delete a service listing
router.delete("/services/:id", authenticateUser, authorizeMiddleware(Action.MANAGE_ORDERS), deleteServiceListing);

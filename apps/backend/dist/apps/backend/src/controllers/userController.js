...
export const requestPasswordReset = async (req, res, next) => {
    try {
        ...
        await sendEmail(user.email, "Password Reset Request", `<p>Hello,</p><p>You requested to reset your password. Click the link below to set a new one:</p><a href="${resetLink}">${resetLink}</a><p>This link will expire in 1 hour.</p>`);

...
export function useServiceCategories(locale: string) {
  ...
  return [
      ...
      serviceSubCategories: [
        {
          ...
          label: t("services.categories.legal.sub.legalConsultation"),
        },
        {
          value: "COMPANY_FORMATION",
          label: t("services.categories.legal.sub.companyFormation"),
        },
        {
          value: "CONSULTING_SERVICES",
          label: t("services.categories.legal.sub.consultingServices"),
        },
        {
          value: "PROCUREMENT_SERVICES",
          label: t("services.categories.legal.sub.procurementServices"),
        },
        {
          value: "MERGERS_AND_ACQUISITIONS",
          label: t("services.categories.legal.sub.mergersAndAcquisitions"),
        },
        {
          value: "LEGAL_DOCUMENT_PREPARATION",
          label: t("services.categories.legal.sub.legalDocumentPreparation"),
        },
      ],
    },
    {
      ...
      features: t(
        "services.categories.finance.features"
      ...
      serviceSubCategories: [
        {
          value: "TAX_ADVISORY",
          label: t("services.categories.finance.sub.taxAdvisory"),
        },
        {
          value: "BANKING_SETUP",
          label: t("services.categories.finance.sub.bankingSetup"),
        },
        {
          value: "FINANCIAL_PLANNING",
          label: t("services.categories.finance.sub.financialPlanning"),
        },
        {
          value: "MARKETING_SERVICES",
          label: t("services.categories.finance.sub.marketingServices"),
        },
        {
          value: "CONSULTING_SERVICES",
          label: t("services.categories.finance.sub.consultingServices"),
        },
      ],
    },
    {
      ...
      serviceSubCategories: [
        {
          value: "IT_SUPPORT",
          label: t("services.categories.tech.sub.itSupport"),
        },
        {
          value: "SOFTWARE_DEVELOPMENT",
          label: t("services.categories.tech.sub.softwareDevelopment"),
        },
        {
          value: "DESIGN_SERVICES",
          label: t("services.categories.tech.sub.designServices"),
        },
        {
          value: "TECH_SUPPORT",
          label: t("services.categories.tech.sub.techSupport"),
        },
        {
          value: "CLOUD_COMPUTING",
          label: t("services.categories.tech.sub.cloudComputing"),
        },
        {
          value: "DATA_MANAGEMENT",
          label: t("services.categories.tech.sub.dataManagement"),
        },
        {
          value: "PROJECT_MANAGEMENT",
          label: t("services.categories.tech.sub.projectManagement"),
        },
        {
          value: "SYSTEM_ADMINISTRATION",
          label: t("services.categories.tech.sub.systemAdministration"),
        },
        {
          value: "TESTING_AND_QUALITY_ASSURANCE",
          label: t("services.categories.tech.sub.testingAndQualityAssurance"),
        },
        {
          value: "ITIL_AND_SERVICE_MANAGEMENT",
          label: t("services.categories.tech.sub.itilAndServiceManagement"),
        },
      ],
    },
    {
      ...
      features: t(
        "services.categories.realEstate.features"
      ) as unknown as string[],
      ...
      serviceSubCategories: [
        {
          ...
          label: t("services.categories.realEstate.sub.realEstateServices"),
        },
        {
          value: "HOME_RENOVATION",
          label: t("services.categories.realEstate.sub.homeRenovation"),
        },
        {
          value: "REPAIR_SERVICES",
          label: t("services.categories.realEstate.sub.repairServices"),
        },
        {
          value: "PROPERTY_MANAGEMENT",
          label: t("services.categories.realEstate.sub.propertyManagement"),
        },
        {
          value: "RETAIL_SALES",
          label: t("services.categories.realEstate.sub.retailSales"),
        },
        {
          value: "REAL_ESTATE_ADVISORY",
          label: t("services.categories.realEstate.sub.realEstateAdvisory"),
        },
        {
          value: "REAL_ESTATE_LEGAL_ADVICE",
          label: t("services.categories.realEstate.sub.realEstateLegalAdvice"),
        },
      ],
    },
    {
      ...
      features: t(
        "services.categories.healthcare.features"
      ) as unknown as string[],
      ...
      serviceSubCategories: [
        {
          ...
          label: t("services.categories.healthcare.sub.healthcareServices"),
        },
        {
          value: "FITNESS_TRAINING",
          label: t("services.categories.healthcare.sub.fitnessTraining"),
        },
        {
          value: "PERSONAL_COACHING",
          label: t("services.categories.healthcare.sub.personalCoaching"),
        },
        {
          value: "BEAUTY_SERVICES",
          label: t("services.categories.healthcare.sub.beautyServices"),
        },
        {
          value: "LIFESTYLE_CONSULTING",
          label: t("services.categories.healthcare.sub.lifestyleConsulting"),
        },
        {
          value: "PET_SERVICES",
          label: t("services.categories.healthcare.sub.petServices"),
        },
        {
          value: "MENTAL_HEALTH_ADVICE",
          label: t("services.categories.healthcare.sub.mentalHealthAdvice"),
        },
        {
          value: "HEALTH_AND_RECOVERY_PROGRAMS",
          label: t(
            "services.categories.healthcare.sub.healthAndRecoveryPrograms"
          ),
        },
      ],
    },
    {
      ...
      features: t(
        "services.categories.entertainment.features"
      ) as unknown as string[],
      ...
      serviceSubCategories: [
        {
          ...
          label: t("services.categories.entertainment.sub.travelPlanning"),
        },
        {
          value: "EVENT_MANAGEMENT",
          label: t("services.categories.entertainment.sub.eventManagement"),
        },
        {
          value: "ENTERTAINMENT_SERVICES",
          label: t(
            "services.categories.entertainment.sub.entertainmentServices"
          ),
        },
        {
          value: "TOUR_GUIDING",
          label: t("services.categories.entertainment.sub.tourGuiding"),
        },
        {
          value: "EVENT_PLANNING",
          label: t("services.categories.entertainment.sub.eventPlanning"),
        },
        {
          value: "ENTERTAINMENT_ADVISORY",
          label: t(
            "services.categories.entertainment.sub.entertainmentAdvisory"
          ),
        },
      ],
    },
    {
      ...
      features: t(
        "services.categories.security.features"
      ) as unknown as string[],
      ...
      serviceSubCategories: [
        {
          ...
          label: t("services.categories.security.sub.securityServices"),
        },
        {
          value: "POLICE_SERVICES",
          label: t("services.categories.security.sub.policeServices"),
        },
        {
          value: "FIRE_SERVICES",
          label: t("services.categories.security.sub.fireServices"),
        },
        {
          value: "SECURITY_ASSISTANCE",
          label: t("services.categories.security.sub.securityAssistance"),
        },
        {
          value: "SECURITY_TRAINING",
          label: t("services.categories.security.sub.securityTraining"),
        },
        {
          value: "EMERGENCY_RESPONSE",
          label: t("services.categories.security.sub.emergencyResponse"),
        },
      ],
    },
    {
      ...
      serviceSubCategories: [
        {
          value: "FOOD_CATERING",
          label: t("services.categories.food.sub.foodCatering"),
        },
        {
          value: "CATERING_SERVICES",
          label: t("services.categories.food.sub.cateringServices"),
        },
        {
          value: "FOOD_DELIVERY",
          label: t("services.categories.food.sub.foodDelivery"),
        },
        {
          value: "RESTAURANT_MANAGEMENT",
          label: t("services.categories.food.sub.restaurantManagement"),
        },
        {
          value: "FOOD_ADVISORY",
          label: t("services.categories.food.sub.foodAdvisory"),
        },
        {
          value: "FOOD_SAFETY_COMPLIANCE",
          label: t("services.categories.food.sub.foodSafetyCompliance"),
        },
        {
          value: "FOOD_PREPARATION",
          label: t("services.categories.food.sub.foodPreparation"),
        },
      ],
    },
    {
      ...
      features: t(
        "services.categories.transportation.features"
      ) as unknown as string[],
      ...
      serviceSubCategories: [
        {
          ...
          label: t("services.categories.transportation.sub.logisticsServices"),
        },
        {
          value: "TRANSPORTATION_SERVICES",
          label: t(
            "services.categories.transportation.sub.transportationServices"
          ),
        },
        {
          value: "DELIVERY_SERVICES",
          label: t("services.categories.transportation.sub.deliveryServices"),
        },
        {
          value: "VEHICLE_RENTAL",
          label: t("services.categories.transportation.sub.vehicleRental"),
        },
        {
          value: "TRANSPORTATION_ADVISORY",
          label: t(
            "services.categories.transportation.sub.transportationAdvisory"
          ),
        },
      ],
    },
    {
      ...
      features: t(
        "services.categories.education.features"
      ) as unknown as string[],
      ...
      serviceSubCategories: [
        {
          ...
          label: t("services.categories.education.sub.tutoringServices"),
        },
        {
          value: "ONLINE_COURSES",
          label: t("services.categories.education.sub.onlineCourses"),
        },
        {
          value: "EDUCATIONAL_ADVISORY",
          label: t("services.categories.education.sub.educationalAdvisory"),
        },
        {
          value: "LANGUAGE_TRAINING",
          label: t("services.categories.education.sub.languageTraining"),
        },
        {
          value: "EDUCATIONAL_RESOURCES",
          label: t("services.categories.education.sub.educationalResources"),
        },
      ],
    },
    {
      ...
      features: t(
        "services.categories.manufacturing.features"
      ) as unknown as string[],
      ...
      serviceSubCategories: [
        {
          value: "MANUFACTURING_SERVICES",
          label: t(
            "services.categories.manufacturing.sub.manufacturingServices"
          ),
        },
        {
          value: "PRODUCTION_MANAGEMENT",
          label: t(
            "services.categories.manufacturing.sub.productionManagement"
          ),
        },
        {
          value: "QUALITY_CONTROL",
          label: t("services.categories.manufacturing.sub.qualityControl"),
        },
        {
          value: "SUPPLY_CHAIN_MANAGEMENT",
          label: t(
            "services.categories.manufacturing.sub.supplyChainManagement"
          ),
        },
        {
          value: "MANUFACTURING_ADVISORY",
          label: t(
            "services.categories.manufacturing.sub.manufacturingAdvisory"
          ),
        },
      ],
    },
      ...
      serviceSubCategories: [
        {
          ...
          label: t("services.categories.sports.sub.sportsCoaching"),
        },
        {
          value: "SPORTS_ADVISORY",
          label: t("services.categories.sports.sub.sportsAdvisory"),
        },
        {
          value: "SPORTS_EQUIPMENT_RENTAL",
          label: t("services.categories.sports.sub.sportsEquipmentRental"),
        },
        {
          value: "SPORTS_EVENT_MANAGEMENT",
          label: t("services.categories.sports.sub.sportsEventManagement"),
        },
      ],
    },
    {
